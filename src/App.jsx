...
const TOPICS = [
  ...
  { icon: "🛠", label: "Fix Errors", prompt: "Explain Excel errors like #VALUE! #REF! #DIV0! and fixes." },
...
export default function App() {
  ...
  const [messages, setMessages] = useState([
    { role: "assistant", content: "👋 Hi! I am ExcelCoach your free AI Excel tutor! Ask me anything or tap a topic below!" },
  ]);
